...
export const STRINGS = {
  ...
  en: {
    ...
    'map.assignTitle': 'Assign & route',
    'map.assignTo': 'Assign to station',
    'map.showRoute': 'Show route',
    'map.routing': 'Routing…',
    'map.routeInfo': '{km} km · {min} min by road',
    'map.clearRoute': 'clear',
    'map.routeErr': 'Could not compute the route.',
    'map.saved': '✓ saved',
    'map.saveErr': 'Could not save.',
  ...
  hi: {
    ...
    'map.assignTitle': 'असाइन और रूट',
    'map.assignTo': 'थाने को असाइन करें',
    'map.showRoute': 'रूट दिखाएँ',
    'map.routing': 'रूट बन रहा है…',
    'map.routeInfo': '{km} किमी · {min} मिनट सड़क मार्ग से',
    'map.clearRoute': 'हटाएँ',
    'map.routeErr': 'रूट की गणना नहीं हो सकी।',
    'map.saved': '✓ सहेजा गया',
    'map.saveErr': 'सहेजा नहीं जा सका।',
  ...
  kn: {
    ...
    'map.assignTitle': 'ನಿಯೋಜಿಸಿ ಮತ್ತು ಮಾರ್ಗ',
    'map.assignTo': 'ಠಾಣೆಗೆ ನಿಯೋಜಿಸಿ',
    'map.showRoute': 'ಮಾರ್ಗ ತೋರಿಸಿ',
    'map.routing': 'ಮಾರ್ಗ ಲೆಕ್ಕ ಹಾಕಲಾಗುತ್ತಿದೆ…',
    'map.routeInfo': '{km} ಕಿಮೀ · {min} ನಿಮಿಷ ರಸ್ತೆ ಮಾರ್ಗದಲ್ಲಿ',
    'map.clearRoute': 'ತೆರವುಗೊಳಿಸಿ',
    'map.routeErr': 'ಮಾರ್ಗವನ್ನು ಲೆಕ್ಕ ಹಾಕಲಾಗಲಿಲ್ಲ.',
    'map.saved': '✓ ಉಳಿಸಲಾಗಿದೆ',
    'map.saveErr': 'ಉಳಿಸಲಾಗಲಿಲ್ಲ.',
